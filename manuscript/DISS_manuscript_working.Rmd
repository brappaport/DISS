...
$$\small [1] ~ RewP=b_{0}+b_{1}Reward~bias+b_{2}Loss~Avoidance+b_{3}Age+b_{4}Income~to~needs~ratio+ b_{5}Sex+b_{6}Race_{1}+b_{7}Race_{2}+b_{8}Hispanic $$ $$\small [2] ~ FN=b_{0}+b_{1}Reward~bias+b_{2}Loss~Avoidance+b_{3}Age+b_{4}Income~to~needs~ratio+ b_{5}Sex+b_{6}Race_{1}+b_{7}Race_{2}+b_{8}Hispanic $$
...
Multiple regression models showed that the RewP to social acceptance feedback was not significantly associated with depression severity, nor was the FN to social rejection feedback significantly associated with depression or social anxiety severity (see Table 3). Zero order correlations further confirmed this pattern of results (Table 2), however, the effect size of the correlation between the RewP and depression severity ($r$=`r myround(rewp_dep_lm[2,]$estimate,2)`, 95% CI [`r rewp_dep_ci`], *p*=`r myround(rewp_dep_lm[2,]$p.value,2)`) was comparable to two large prior studies using indepedent samples ($r$=-0.10, total $N$=`r 412+231`; @kujawaSocialProcessingEarly2017; @peggBluntedSocialReward2019). Results from supplemental analyses including recent psychotropic medication use were consistent (Table S\#).
