...
DISS_cleaning_tw_components_wide <- DISS_cleaning_tw_components %>%
  pivot_wider(id_cols=Subid, names_from=Condition, values_from=c(rewp,rewp275375,rewp250350,p2,n1))
...
DISS_cleaning_tw_components_wide$fn_r <- -1*stdres(lm(rewp_REJ ~ rewp_ACC, DISS_cleaning_tw_components_wide, na.action=na.exclude))
DISS_cleaning_tw_components_wide$n1_r <- -1*stdres(lm(n1_REJ ~ n1_ACC, DISS_cleaning_tw_components_wide, na.action=na.exclude))
