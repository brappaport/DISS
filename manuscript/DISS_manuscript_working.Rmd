...
$$ [1] ~ RewP=b_{0}+b_{1}Reward~bias+b_{2}Loss~Avoidance+b_{3}Age+b_{4}Income~to~needs~ratio+ b_{5}Sex+b_{6}Race_{1}+b_{7}Race_{2}+b_{8}Hispanic $$
$$ [2] ~ FN=b_{0}+b_{1}Reward~bias+b_{2}Loss~Avoidance+b_{3}Age+b_{4}Income~to~needs~ratio+ b_{5}Sex+b_{6}Race_{1}+b_{7}Race_{2}+b_{8}Hispanic $$
