...
# Check that both datasets removed one participant
...
DISS_do01.imp <- mice(DISS_do01_nooutliers[,c(all_measures_list)], predictorMatrix=pred, method=meth, m=10, seed=314)

# DISS_do01.imp <- mice(DISS_do01_nooutliers[,c(all_measures_list, "S5psychmed_dos_f")], m = 10, method = 'pmm', seed=314) #generate 10 imputed datasets
