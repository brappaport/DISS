...
# Check the PILT is calculated similarly to papst waves
```{r}
...
rewp_i2n <- lm(rewp_r ~ Income_to_Need + S5MDDCore.x + S5_SIASSPS + T20age.x + sex.x + PDSIII_Race.x + PDSIII_Hispanic.x, DISS_do04_exp) #* #fdr*
fn_i2n <- lm(fn_r ~ Income_to_Need + S5MDDCore.x + S5_SIASSPS + T20age.x + sex.x + PDSIII_Race.x + PDSIII_Hispanic.x, DISS_do04_exp)
p2_i2n <- lm(p2_r ~ Income_to_Need + S5MDDCore.x + S5_SIASSPS + T20age.x + sex.x + PDSIII_Race.x + PDSIII_Hispanic.x, DISS_do04_exp) #*
