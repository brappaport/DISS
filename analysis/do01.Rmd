...
#Correlation
f1 <- 
  brm_multiple(data = DISS_do01.imp_z, 
      family = gaussian,
...
cor.rewp_sym <- brm_multiple(data = DISS_do01.imp_z, 
      family = gaussian,
...
cor_test <- stan(file="robust_correlation.stan", data=DISS_do01.imp_z, 
                 iter=2000, warmup=500, chains=4, seed=919)

ggplot(DISS_do01.imp_z, aes(y=rewp_r_z, x=S5cdic_bdi_perc_z)) +
  geom_point()
