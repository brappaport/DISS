...
library(CTT)
icc_rewardbias <- irr::icc(splithalf_p[,c("Reward_bias_20_1", "Reward_bias_20_2")], model="oneway", unit="single", r0=0)
icc_lossbias <- irr::icc(splithalf_n[,c("Loss_bias_20_1", "Loss_bias_20_2")], model="oneway", unit="single", r0=0)
spearman.brown(as.numeric(icc_rewardbias[7]))
spearman.brown(as.numeric(icc_lossbias[7]))
```
