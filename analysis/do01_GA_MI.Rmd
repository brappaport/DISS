...
## 4.1. Test MCAR
```{r}
TestMCARNormality(data=DISS_do01_nooutliers[,var_interest_n], imputation.number=10, imputation.method="Dist.Free", seed=919)
```
...
DISS_do01.imp <- mice(DISS_do01_nooutliers[,var_interest_f], m = 10, method = 'pmm', seed=919) #generate 10 imputed datasets
