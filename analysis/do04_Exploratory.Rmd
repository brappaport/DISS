...
```{r}
# DISS_do01.imp <- mice(DISS_do01[,c(2:5,10:13,18:20)], m = 10, method = 'pmm', seed=314) #generate 10 imputed datasets
...
# 3. With N1 component
```{r}
summary(lm(n1_r ~ Reward_bias_20 + Loss_bias_20 + T20age + sex_f + PDSIII_Race_f + PDSIII_Hispanic_f + Income_to_Need, DISS_do04))
summary(lm(n1_r ~ Reward_bias_20 + Loss_bias_20, DISS_do04))

summary(lm(n1_r ~ S5cdic_bdi_perc + S5_SIASSPS + T20age + sex_f + PDSIII_Race_f + PDSIII_Hispanic_f + Income_to_Need, DISS_do04))
summary(lm(n1_r ~ S5cdic_bdi_perc + S5_SIASSPS, DISS_do04))

summary(lm(n1_r ~ T20_ADHD, DISS_do04_exp))
```
