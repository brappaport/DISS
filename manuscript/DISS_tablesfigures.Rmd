...
tfsf.plots <- ggarrange(cz_ga_plot, tf2sf1_ga_plot, tf4sf1_ga_plot, tf7sf1_ga_plot,
          ...
          ncol = 1, nrow = 4,
          align="v")
tfsf.plots <- annotate_figure(tfsf.plots, left=text_grob("Average activity (µV)", color = "black", rot = 90))
tfsf.plots
...
```{r I2Nplot, echo=FALSE, dev='pdf', fig.height=5, fig.width=7, fig.align="center", fig.cap = "Relationship between RewP to social acceptance and income to needs ratio with histograms", out.width='100%'}
library(ggExtra)
...
I2N_rewp_marg <- ggMarginal(I2N_rewp, type="histogram", size=4)
I2N_rewp_marg
```
...
I2N_table_disc <- DISS_make_table(first_model=mr.rb_i2n_disc, second_model=mr.la_i2n_disc, predictors=c("Intercept", "Depression", "Social Anxiety", "PILT-P Accuracy", "PILT-N Accuracy","Age", "Sex", "Black or AA", "Multiracial", "Hispanic", "SES", "Psychotropic medication use"))
```
