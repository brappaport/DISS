...
```{r Facetplots, echo=FALSE, dev='pdf', fig.height=10, fig.width=7, fig.align="center", fig.cap = "ERP waveforms to acceptance and rejection feedback", out.width='100%'}
...
```{r SEMplotprint, fig.cap = "SEM model of all hypotheses. Note: Values are beta coefficient (p values)", out.width='100%'}
plot(full_model_plot)
```

```{r I2Nplot, echo=FALSE, dev='pdf', fig.height=5, fig.width=7, fig.align="center", fig.cap = "RewP to social acceptance and income to needs ratio", out.width='100%'}
